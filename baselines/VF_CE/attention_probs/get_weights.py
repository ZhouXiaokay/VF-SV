...
dir_path = r'optdigits'
client_num = 4

# 加载保存的weights
list_attn_weights = torch.load(dir_path + '/probs/last_ep_attn_weights_scalar.pt', weights_only=False)
...
for i in range(client_num):
    ...
    plt.legend()
    filename = f'{dir_path}/save/client_{i+1}_gaussian.pdf'
    plt.show()
...
# 指定 CSV 文件路径
csv_file_path = dir_path + '/save/attn_weights.csv'
