...
def mean_marginal_contribution(rank, mi_values, world_size ,group_keys):
...
def cal_mci_value(world_size, client_mi_values, group_keys):
    ...
    for client in range(world_size):
        mean_contribution = mean_marginal_contribution(client, client_mi_values, world_size, group_keys)
        client_group[client] = mean_contribution
