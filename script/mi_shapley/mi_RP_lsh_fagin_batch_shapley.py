...
from trainer.knn_mi_RP.mi_lsh_fagin_batch_trainer import LSHFaginBatchTrainer
...
def run(args):
    ...
    logging.basicConfig(level=logging.DEBUG,
                        filename=code_path + '/logs/ablation_study/batch_lsh.log',
                        datefmt='%Y/%m/%d %H:%M:%S',
    ...
    if args.rank == 0:
        ...
        logger.info("number of train data = {}".format(n_train))
